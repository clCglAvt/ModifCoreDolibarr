 ...
 *
 * Modif CCA 25/2/2014 - Facture au commissionnement 
 * MODIF CCA 16/1/2017 Montée de version 4.0.3
...
class pdf_FAmarge extends ModelePDFFactures
// Fin Modif 
{
    var $db;
    var $name;
...
// Fin Modif
		...
		$this->db = $db;
//Modif CCA 25/2/2014 - Facture à la marge
		//$this->name = "crabe";
		$this->name = "operateur";
...
//Modif CCA 25/2/2014 - Facture commissionnement
...
//Modif CCA 3/3/2014 - Immatriculation Opérateur
				...
				$pdf->SetXY($col1x, $tab2_top + $tab2_hl * $index +5);				
...
//Modif CCA 15/5/2015 - Immatriculation Opérateur
			//$index++;
			$index = $index + $nbligneajouteoperateur;
//fin Modif CCA 15/5/2015 -
			$pdf->SetXY($col1x, $tab2_top + $tab2_hl * $index);
