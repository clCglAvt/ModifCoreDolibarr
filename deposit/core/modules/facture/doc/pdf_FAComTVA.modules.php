 ...
 *
 * Modif CCA 25/2/2014
 * facture pour du l'activité Opérateur
 ...
 */
//Modif CCA 25/2/2014  facture pour du l'activité Opérateur
//class pdf_crabe extends ModelePDFFactures
class pdf_FAComTVA extends ModelePDFFactures
// Fin Modif
{
    var $db;
    var $name;
...
// Fin Modif
		...
		$this->db = $db;
// Modif CCA 3/2/14 - facture pour du l'activité Opérateur
		//$this->name = "crabe";
		$this->name = "Comm&TVA";
...
//Modif CCA 25/2/2014 - Facture facture Opérateur
						//$pdf->MultiCell($this->posxup-$this->posxtva-0.8, 3, $vat_rate, 0, 'R');
						if ($object->lines[$i]->tva_tx <> 0) 
						{
//fin Modif CCA 25/2/2014 -
							$pdf->MultiCell($this->posxup-$this->posxtva-1, 3, $vat_rate, 0, 'R');
//Modif CCA 25/2/2014 - facture Opérateur
						}
						else
						{
							$pdf->MultiCell($this->posxup-$this->posxtva-1, 3, '(*)', 0, 'R');
						}
//fin Modif CCA 25/2/2014 -
...
//Modif CCA 25/2/2014 - facture Opérateur
		// Mention propre au conditionnement
			...
			$pdf->SetXY($this->marge_gauche, $posy);
			$pdf->MultiCell(120, 3, $outputlangs->transnoentities("VATCommCompteMoniteurTVA"), 0, 'L', 0);
			$posy=$pdf->GetY()+3;
//fin Modif CCA 25/2/2014 -
