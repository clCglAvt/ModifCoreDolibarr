...
//class pdf_FAcomm extends ModelePDFFactures
class pdf_FAcomm extends ModelePDFFactures
//Fin Modif CCA 
...
//Modif CCA 25/2/2014 - Facture commissionnement
		// Mention propre au conditionnement
			...
			$pdf->MultiCell(100, 3, $outputlangs->transnoentities("VATCommCompteMoniteur"), 0, 'L', 0);
			$posy=$pdf->GetY()+3;
//fin Modif CCA 25/2/2014 -
...
//Modif CCA 16/1/2017 Montée de version 4.0.3
			...
			$pdf->MultiCell($largcol2, $tab2_hl+ $tab2_hl * $index, price($deja_regle + $depositsamount, 0, $outputlangs), 0, 'R', 0);
// fin modif
