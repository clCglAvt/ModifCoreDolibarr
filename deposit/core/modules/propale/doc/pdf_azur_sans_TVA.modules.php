...
class pdf_azur_sans_TVA extends ModelePDFPropales
//Fin Modif CCA
{
	var $db;
	var $name;
...
//Modif CCA 3/3/2014 - Propale commissionnement
...
//Modif CCA 3/3/2014 - Propale commissionnement
		// Mention propre au commissionnement
			$pdf->SetFont('','B', $default_font_size - 2);
			$pdf->SetXY($this->marge_gauche, $posy);
			$pdf->MultiCell(100, 3, $outputlangs->transnoentities("VATCommPropalCompteMoniteur"), 0, 'L', 0);
			$posy=$pdf->GetY()+4;
//fin Modif CCA 3/3/2014 -
        // Show shipping date
		...
		{
			$pdf->SetFont('','B', $default_font_size - 2);
//Modif CCA 25/2/2014 - Propale commissionnement
			//$pdf->SetXY($this->marge_gauche, $posy);
...
//Modif CCA 3/3/2014 - Propale commissionnement
				...
				$pdf->SetFont('','', $default_font_size - 2);
				$pdf->SetXY($col1x, $tab2_top + $tab2_hl * $index);
				$pdf->MultiCell($largcol1, $tab2_hl, $outputlangs->transnoentities("VATCommissionnement"), 0, 'L', 0);
