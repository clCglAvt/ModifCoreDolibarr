 ...
 *
 * Modif CCA 30/1/2013 - Propal Nette de taxe 
 * Proposition dans un régime dérogation , c'est à dire en net de taxe
 * Modif CCA 3/3/2014 - Propale au commissionnement 
 * Modif CCA 3/3/2014 - Opérateur
 * Modif CCA 16/1/2017 - Montée version 4.0.3
 * Modif CCA pour la 4.0.4 en gardant modif CCA 12/4/17
 *
 ...
 */
//Modif CCA 3/2/14 - Nom modèle
class pdf_azur_marge extends ModelePDFPropales
//Fin Modif CCA
{
	var $db;
	var $name;
...
//fin Modif CCA 30/1/2013 
		...
		if($conf->global->PRODUCT_USE_UNITS)
		{
			...
			$this->posxqty=133;
 // Modif CCA pour la 4.0.4 en gardant modif CCA 12/4/17
if (DOL_VERSION < '4.0.4')			$this->posxunit=150;
else								$this->posxunit=147;
 // Modif CCA pour la 4.0.4 en gardant modif CCA 12/4/17
		}
		else
		{
...
// MODIF CCA 16/1/2017 Migration 4.0.3
					// VAT Rate
...
//fin Modif CCA 3/3/2014  -
		...
		{
			$pdf->SetFont('','B', $default_font_size - 2);
//Modif CCA 25/2/2014 - Propale au commissionnement
			//$pdf->SetXY($this->marge_gauche, $posy);
			$pdf->SetXY($this->marge_gauche, $posy-2);
//fin Modif CCA 25/2/2014 -
...
//Modif CCA 25/2/2014 - Propale au commissionnement
			...
			$pdf->MultiCell(120, 4, $lib_condition_paiement,0,'L');
//fin Modif CCA 25/2/2014 -
...
//Modif CCA - 31/1/2014 - Propal sans TVA
/*
		// Total HT
...
//Modif CCA 3/3/2014 - Propale à la marge
				//$pdf->MultiCell($col2x-$col1x, $tab2_hl, $outputlangs->transnoentities("TotalTTC"), $useborder, 'L', 1);
				$pdf->MultiCell($col2x-$col1x, $tab2_hl, $outputlangs->transnoentities("TotalTTCSpec"), $useborder, 'L', 1);
//fin Modif CCA 3/3/2014 -
...
//Modif CCA 3/3/2014 - Propale à la marge
				$pdf->SetFont('','', $default_font_size - 2);
				$index++;
				$pdf->SetXY($col1x - 1, $tab2_top + $tab2_hl * $index);
				$pdf->MultiCell($largcol1, $tab2_hl, $outputlangs->transnoentities("VATMarge"), 0, 'L', 0);
				$pdf->SetFont('','', $default_font_size);
//fin Modif CCA 3/3/2014 -
			
//Modif CCA 3/3/2014 - Immatriculation Opérateur
				$pdf->SetFont('','', $default_font_size - 3);
				$index++;
				$pdf->SetXY($col1x, $tab2_top + $tab2_hl * $index +4);
				$pdf->MultiCell($largcol1, $tab2_hl, $outputlangs->transnoentities("ImmatriculationOperateurLib"), 0, 'L', 0);
				$pdf->SetXY($col1x, $tab2_top + $tab2_hl * $index +7);				
				$pdf->MultiCell($largcol1, $tab2_hl, $outputlangs->transnoentities("CautionOperateurLib"), 0, 'L', 0);
				$pdf->SetXY($col1x, $tab2_top + $tab2_hl * $index +10);				
				$pdf->MultiCell($largcol1, $tab2_hl, $outputlangs->transnoentities("AssuranceOperateurLib"), 0, 'L', 0);
...
//fin Modif CCA 3/3/2014 -
		...
		*/
//Modif CCA 16/1/2017 - Montée version 4.0.3
	$tab2_top = $tab2_top + 10;
//fin Modif CCA 16/1/2017
		if ($deja_regle > 0)
		{
			$index++;
